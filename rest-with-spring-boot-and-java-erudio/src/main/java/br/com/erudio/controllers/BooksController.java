...
public class BooksController {
	...
	@Operation(summary = "Adds a new Books",
			description = "Adds a new Books by passing in a JSON, XML or YML representation of the book",
			tags = {"Book"},
			responses = {
	...
	@Operation(summary = "Updates a Books",
			description = "Updates a Books by passing in a JSON, XML or YML representation of the book",
			tags = {"Book"},
			responses = {
	...
	@Operation(summary = "Deletes a Books",
			description = "Deletes a Books by passing in a JSON, XML or YML representation of the book",
			tags = {"Book"},
			responses = {
					@ApiResponse(description = "No content", responseCode = "204", content = @Content),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
